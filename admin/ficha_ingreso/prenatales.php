      ...
      <h4>
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group">
            <label for="edad_maternal" class="col-lg-6 control-label">Edad maternal</label>
            <div class="col-lg-6">
              <input type="number" name="edad_maternal" class="form-control input-sm">
            </div>
          </div> 

          <div class="form-group ">
            <label for="escolaridad" class="col-lg-6 control-label">Años de escolaridad</label>
            <div class="col-lg-6">
                <input type="number" name="escolaridad" class="form-control input-sm">
              </div>
          </div>

          <div class="form-group ">
            <label for="escolaridad" class="col-lg-6 control-label">Nivel educacional</label>
            <div class="col-lg-6">
          ...
          <div class="form-group">
            <label for="edad_maternal" class="col-lg-6 control-label">Control de embarazo</label>
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group">
            <label for="tabaquismo" class="col-lg-6 control-label">Tabaquísmo</label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="diabetes" class="col-lg-6 control-label">Diabetes</label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="ht_art" class="col-lg-6 control-label">HT Art</label>
            <label for="ht_art" class="control-label radio-inline col-lg-2">
              <input type="radio" name="ht_art" value="si"> Sí
            </label>
            <label for="ht_art" class="control-label radio-inline col-lg-2" >
              <input type="radio" name="ht_art"  value="no"> No
            </label>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="form-group sub-form">
            <label for="hipertension" class="col-lg-6 control-label">Hipertensión en el embarazo</label>
            <label for="diabetes_gestacional" class="control-label radio-inline col-lg-2">
              <input type="radio" name="diabetes_gestacional" value="si"> Sí
            </label>
            <label for="diabetes_gestacional" class="control-label radio-inline col-lg-2" >
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="multiple" class="col-lg-6 control-label">Múltiple</label>
            <label for="multiple" class="control-label radio-inline col-lg-2">
              <input type="radio" name="multiple" value="si"> Sí
            </label>
            <label for="multiple" class="control-label radio-inline col-lg-2" >
              <input type="radio" name="multiple"  value="no"> No
            </label>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="form-group sub-form">
            <label for="Paridad" class="col-lg-6 control-label">Lugar</label>
            <div class="col-lg-4">
              <select name="paridad" class="form-control input-sm">
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="rciu" class="col-lg-6 control-label">RCIU</label>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3 input-group linea">
              <input type="number" name="rpm_dias" class="form-control input-sm" aria-describedby="basic-addon2">
              <span class="input-group-addon" id="basic-addon2">días</span>
            </div>
            <div class="col-lg-3 input-group linea">
              <input type="number" name="rpm_hrs" class="form-control input-sm" aria-describedby="basic-addon2">
              <span class="input-group-addon" id="basic-addon2">hrs.</span>
            </div>
          </div>

          <div class="form-group">
            <label for="antibiotico" class="col-lg-6 control-label">Antibiótico prentala</label>
        ...
        <div class="col-lg-6">
          ...
          <div class="form-group">
            <label for="cort_prenatal" class="col-lg-6 control-label">Cort. prenatal</label>
            <label for="cort_prenatal" class="control-label radio-inline col-lg-2">
              <input type="radio" name="cort_prenatal" value="si"> Sí
            </label>
            <label for="cort_prenatal" class="control-label radio-inline col-lg-2" >
              <input type="radio" name="cort_prenatal"  value="no"> No
            </label>
          </div>
        ...
        <div class="col-lg-6">
          <div class="form-group sub-form">
            <label for="completo" class="control-label radio-inline col-lg-3">
              <input type="radio" name="completo" value="si"> Incompleto
            </label>
            <label for="completo" class="control-label radio-inline col-lg-3" >
              <input type="radio" name="completo" value="no"> Completo
            </label>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-lg-offset-6">
          <div class="form-group sub-form">
            <label for="cursp" class="control-label radio-inline col-lg-3">
              <input type="radio" name="cursp" value="si"> 1 curso
            </label>
            <label for="cursp" class="control-label radio-inline col-lg-3" >
              <input type="radio" name="cursp" value="no"> más de 1 curso
            </label>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="corioamnionitis" class="col-lg-6 control-label">Corioamnionitis</label>
          ...
          <div class="form-group">
            <label for="sulfato" class="col-lg-6 control-label">Sulfato de Mg</label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="doppler" class="col-lg-6 control-label">Alteración del doppler fetal</label>
        ...
        <div class="col-lg-6">
          <div class="form-group">
            <label for="malformacion" class="col-lg-6 control-label">Malformación cognitiva mayor</label>
          ...
          <div class="form-group sub-form">
            <div class="form-group sub-form">
              <label for="compromete" class="control-label radio-inline col-lg-5">
                <input type="radio" name="compromete" value="no"> No compromete la vida
              </label>
              <label for="compromete" class="control-label radio-inline col-lg-5" >
                <input type="radio" name="compromete"  value="si"> Compromete la vida
              </label>
            </div>
          </div>
