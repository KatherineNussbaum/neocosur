<div class="ficha panel panel-default">
  <div class="panel-body">
    <form>
      <button class="btn btn-success active subtitulo" type="button" id="sec_connatales"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true" ></span> Anlimentación</button>
